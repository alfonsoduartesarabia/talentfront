...
public class UserImage extends TableImpl<UserImageRecord> {
    ...
    private static final long serialVersionUID = -1566032661;
    ...
    /**
     * The column <code>db.user_image.content_type</code>.
     */
    public final TableField<UserImageRecord, String> CONTENT_TYPE = createField(DSL.name("content_type"), org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");
