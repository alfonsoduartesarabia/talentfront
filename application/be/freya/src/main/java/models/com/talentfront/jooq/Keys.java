...
public class Keys {
    ...
    public static final Identity<CompanyImageRecord, Integer> IDENTITY_COMPANY_IMAGE = Identities0.IDENTITY_COMPANY_IMAGE;
    public static final Identity<CompanyLocationRecord, Integer> IDENTITY_COMPANY_LOCATION = Identities0.IDENTITY_COMPANY_LOCATION;
    ...
    public static final Identity<PostingRequirementRecord, Integer> IDENTITY_POSTING_REQUIREMENT = Identities0.IDENTITY_POSTING_REQUIREMENT;
    public static final Identity<UserRecord, Integer> IDENTITY_USER = Identities0.IDENTITY_USER;
    public static final Identity<UserCompanyRecord, Integer> IDENTITY_USER_COMPANY = Identities0.IDENTITY_USER_COMPANY;
    ...
    public static final Identity<UserSkillRecord, Integer> IDENTITY_USER_SKILL = Identities0.IDENTITY_USER_SKILL;
    ...
    public static final UniqueKey<CompanyImageRecord> KEY_COMPANY_IMAGE_PRIMARY = UniqueKeys0.KEY_COMPANY_IMAGE_PRIMARY;
    public static final UniqueKey<CompanyLocationRecord> KEY_COMPANY_LOCATION_PRIMARY = UniqueKeys0.KEY_COMPANY_LOCATION_PRIMARY;
    ...
    public static final UniqueKey<PostingRequirementRecord> KEY_POSTING_REQUIREMENT_PRIMARY = UniqueKeys0.KEY_POSTING_REQUIREMENT_PRIMARY;
    public static final UniqueKey<UserRecord> KEY_USER_PRIMARY = UniqueKeys0.KEY_USER_PRIMARY;
    public static final UniqueKey<UserCompanyRecord> KEY_USER_COMPANY_PRIMARY = UniqueKeys0.KEY_USER_COMPANY_PRIMARY;
    ...
    public static final ForeignKey<CompanyImageRecord, CompanyRecord> COMPANY_IMAGE_COMPANY_ID_FK = ForeignKeys0.COMPANY_IMAGE_COMPANY_ID_FK;
    public static final ForeignKey<CompanyLocationRecord, CompanyRecord> COMPANY_LOCATION_COMPANY_ID_FK = ForeignKeys0.COMPANY_LOCATION_COMPANY_ID_FK;
    ...
    public static final ForeignKey<PostingRequirementRecord, PostingRecord> POSTING_REQUIREMENT_POSTING_ID_FK = ForeignKeys0.POSTING_REQUIREMENT_POSTING_ID_FK;
    public static final ForeignKey<UserRecord, UserTypeRecord> USER_TYPE_ID_FK = ForeignKeys0.USER_TYPE_ID_FK;
    public static final ForeignKey<UserCompanyRecord, UserRecord> USER_COMPANY_USER_ID_FK = ForeignKeys0.USER_COMPANY_USER_ID_FK;
    ...
    public static final ForeignKey<UserSkillRecord, UserRecord> USER_SKILL_USER_ID_FK = ForeignKeys0.USER_SKILL_USER_ID_FK;
    ...
    private static class Identities0 {
        public static Identity<CompanyRecord, Integer> IDENTITY_COMPANY = Internal.createIdentity(Company.COMPANY, Company.COMPANY.COMPANY_ID);
        public static Identity<CompanyImageRecord, Integer> IDENTITY_COMPANY_IMAGE = Internal.createIdentity(CompanyImage.COMPANY_IMAGE, CompanyImage.COMPANY_IMAGE.COMPANY_IMAGE_ID);
        public static Identity<CompanyLocationRecord, Integer> IDENTITY_COMPANY_LOCATION = Internal.createIdentity(CompanyLocation.COMPANY_LOCATION, CompanyLocation.COMPANY_LOCATION.COMPANY_LOCATION_ID);
        ...
        public static Identity<PostingRequirementRecord, Integer> IDENTITY_POSTING_REQUIREMENT = Internal.createIdentity(PostingRequirement.POSTING_REQUIREMENT, PostingRequirement.POSTING_REQUIREMENT.POSTING_REQUIREMENT_ID);
        public static Identity<UserRecord, Integer> IDENTITY_USER = Internal.createIdentity(User.USER, User.USER.USER_ID);
        public static Identity<UserCompanyRecord, Integer> IDENTITY_USER_COMPANY = Internal.createIdentity(UserCompany.USER_COMPANY, UserCompany.USER_COMPANY.USER_COMPANY_ID);
        ...
        public static Identity<UserSkillRecord, Integer> IDENTITY_USER_SKILL = Internal.createIdentity(UserSkill.USER_SKILL, UserSkill.USER_SKILL.USER_SKILL_ID);
    ...
    private static class UniqueKeys0 {
        public static final UniqueKey<CompanyRecord> KEY_COMPANY_PRIMARY = Internal.createUniqueKey(Company.COMPANY, "KEY_company_PRIMARY", new TableField[] { Company.COMPANY.COMPANY_ID }, true);
        public static final UniqueKey<CompanyImageRecord> KEY_COMPANY_IMAGE_PRIMARY = Internal.createUniqueKey(CompanyImage.COMPANY_IMAGE, "KEY_company_image_PRIMARY", new TableField[] { CompanyImage.COMPANY_IMAGE.COMPANY_IMAGE_ID }, true);
        public static final UniqueKey<CompanyLocationRecord> KEY_COMPANY_LOCATION_PRIMARY = Internal.createUniqueKey(CompanyLocation.COMPANY_LOCATION, "KEY_company_location_PRIMARY", new TableField[] { CompanyLocation.COMPANY_LOCATION.COMPANY_LOCATION_ID }, true);
        ...
        public static final UniqueKey<PostingRequirementRecord> KEY_POSTING_REQUIREMENT_PRIMARY = Internal.createUniqueKey(PostingRequirement.POSTING_REQUIREMENT, "KEY_posting_requirement_PRIMARY", new TableField[] { PostingRequirement.POSTING_REQUIREMENT.POSTING_REQUIREMENT_ID }, true);
        ...
        public static final UniqueKey<UserCompanyRecord> KEY_USER_COMPANY_PRIMARY = Internal.createUniqueKey(UserCompany.USER_COMPANY, "KEY_user_company_PRIMARY", new TableField[] { UserCompany.USER_COMPANY.USER_COMPANY_ID }, true);
        ...
        public static final UniqueKey<UserSkillRecord> KEY_USER_SKILL_PRIMARY = Internal.createUniqueKey(UserSkill.USER_SKILL, "KEY_user_skill_PRIMARY", new TableField[] { UserSkill.USER_SKILL.USER_SKILL_ID }, true);
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<CompanyImageRecord, CompanyRecord> COMPANY_IMAGE_COMPANY_ID_FK = Internal.createForeignKey(Keys.KEY_COMPANY_PRIMARY, CompanyImage.COMPANY_IMAGE, "company_image_company_id_fk", new TableField[] { CompanyImage.COMPANY_IMAGE.COMPANY_ID }, true);
        public static final ForeignKey<CompanyLocationRecord, CompanyRecord> COMPANY_LOCATION_COMPANY_ID_FK = Internal.createForeignKey(Keys.KEY_COMPANY_PRIMARY, CompanyLocation.COMPANY_LOCATION, "company_location_company_id_fk", new TableField[] { CompanyLocation.COMPANY_LOCATION.COMPANY_ID }, true);
        ...
        public static final ForeignKey<PostingRequirementRecord, PostingRecord> POSTING_REQUIREMENT_POSTING_ID_FK = Internal.createForeignKey(Keys.KEY_POSTING_PRIMARY, PostingRequirement.POSTING_REQUIREMENT, "posting_requirement_posting_id_fk", new TableField[] { PostingRequirement.POSTING_REQUIREMENT.POSTING_ID }, true);
        ...
        public static final ForeignKey<UserCompanyRecord, UserRecord> USER_COMPANY_USER_ID_FK = Internal.createForeignKey(Keys.KEY_USER_PRIMARY, UserCompany.USER_COMPANY, "user_company_user_id_fk", new TableField[] { UserCompany.USER_COMPANY.USER_ID }, true);
        ...
        public static final ForeignKey<UserSkillRecord, UserRecord> USER_SKILL_USER_ID_FK = Internal.createForeignKey(Keys.KEY_USER_PRIMARY, UserSkill.USER_SKILL, "user_skill_user_id_fk", new TableField[] { UserSkill.USER_SKILL.USER_ID }, true);
    }
}
