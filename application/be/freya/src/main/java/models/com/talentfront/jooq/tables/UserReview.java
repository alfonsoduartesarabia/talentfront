...
public class UserReview extends TableImpl<UserReviewRecord> {
    ...
    private static final long serialVersionUID = -114532708;
    ...
    /**
     * The column <code>db.user_review.review_stars</code>.
     */
    public final TableField<UserReviewRecord, Integer> REVIEW_STARS = createField(DSL.name("review_stars"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
