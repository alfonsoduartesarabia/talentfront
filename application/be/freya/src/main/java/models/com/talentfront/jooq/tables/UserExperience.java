...
public class UserExperience extends TableImpl<UserExperienceRecord> {
    ...
    private static final long serialVersionUID = -1040090187;
     ...
     */
    public final TableField<UserExperienceRecord, String> JOB_TITLE = createField(DSL.name("job_title"), org.jooq.impl.SQLDataType.VARCHAR(45), this, "");

    /**
     * The column <code>db.user_experience.experience</code>.
     */
    public final TableField<UserExperienceRecord, String> EXPERIENCE = createField(DSL.name("experience"), org.jooq.impl.SQLDataType.VARCHAR(45), this, "");
