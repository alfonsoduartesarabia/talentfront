...
public class Posting extends TableImpl<PostingRecord> {
    ...
    private static final long serialVersionUID = -1991673116;
    ...
    /**
     * The column <code>db.posting.experience_required</code>.
     */
    public final TableField<PostingRecord, Integer> EXPERIENCE_REQUIRED = createField(DSL.name("experience_required"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    /**
     * The column <code>db.posting.zip_code</code>.
     */
    public final TableField<PostingRecord, Integer> ZIP_CODE = createField(DSL.name("zip_code"), org.jooq.impl.SQLDataType.INTEGER, this, "");
