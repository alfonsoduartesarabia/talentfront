...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record7<Integer, String, String, String, Integer, String, String> {

    private static final long serialVersionUID = 1452121506;
     ...
     */
    public void setSaltPasswordHash(String value) {
        set(2, value);
    }
    ...
    @Override
    public UserRecord values(Integer value1, String value2, String value3, String value4, Integer value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Integer userId, String email, String saltPasswordHash, String salt, Integer userTypeId, String firstName, String lastName) {
        super(User.USER);
